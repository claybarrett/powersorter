...
ap.add_argument("-i", "--input", required=False, action="store_true", \
...
ap.add_argument("-g", "--generate_derivatives", action="store_true", \
    help="Attempt to make derivatives if ALL are missing. Evaluates by input/subset folder, not by image.")
...
def generate_url_records_suffixes(settings=None, input_file=None):
    """
